...
class AnnouncementsSedder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('announcements')->insert([
            'title'=>'ELAZIĞ TSO AKADEMİ EĞİTİMLERİ BAŞLADI',
            'isPublished'=>rand(0,1),
            'image'=>'/uploads/duyurular/1.jpeg',
            'description'=>'Elazığ TSO, TradeValley ve Harput Ajans İşbirliğinde Elazığ TSO Akademi 2021 Yılı Eğitim Takvimi kapsamında 01 Nisan 2021 tarihinde saat: 15.00-16.00 arasında “DÜNYA İŞİNİZE AÇIK” başlığı ile Dış Ticaret Bilgilendirme organizasyonu gerçekleştirilecektir.',
