...
class AboutSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('abouts')->insert([
            ...
            'description'=>'Dünyada Ticaret ve Sanayi Odalarının ortaya çıkış XVl.yüzyılın sonralına rastlar. Ticaret Odası adını alan ilk kuruluş Marsilya Ticaret Odası olup, kuruluş yılı 1600’dür. Kuzey Amerika’da ilk Ticaret Odası 1768’de New York’ta kurulmuştur.  Kanada’da ilk Ticaret Odası ise 1804 yılında Halifax’ta açılmıştır.
